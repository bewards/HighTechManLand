...
.mce-primary {
  ...
  border-color: #86ccef #86ccef #86ccef #86ccef;
  background: white;
  background-color: #f9fcfd;
  background-image: -moz-linear-gradient(top, #ffffff, #f1f8fb);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#ffffff), to(#f1f8fb));
  background-image: -webkit-linear-gradient(top, #ffffff, #f1f8fb);
  background-image: -o-linear-gradient(top, #ffffff, #f1f8fb);
  background-image: linear-gradient(to bottom, #ffffff, #f1f8fb);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#fff1f8fb', GradientType=0);
  zoom: 1;
}
.mce-primary:hover,
.mce-primary:focus {
  background-color: #f0f7fc;
  background-image: -moz-linear-gradient(top, #ffffff, #d9eaf8);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#ffffff), to(#d9eaf8));
  background-image: -webkit-linear-gradient(top, #ffffff, #d9eaf8);
  background-image: -o-linear-gradient(top, #ffffff, #d9eaf8);
  background-image: linear-gradient(to bottom, #ffffff, #d9eaf8);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#ffd9eaf8', GradientType=0);
  zoom: 1;
}
...
.mce-primary:not(.mce-disabled):active {
  border-color: #2ca6e3 #2ca6e3 #2ca6e3 #2ca6e3;
  background: #d7e9f7;
  -webkit-box-shadow: inset 0 2px 4px #93b3cc;
  -moz-box-shadow: inset 0 2px 4px #93b3cc;
  box-shadow: inset 0 2px 4px #93b3cc;
}
.mce-primary button,
...
@font-face {
  ...
  src: url('fonts/wysiwyg.eot?2140760#iefix') format('embedded-opentype'), url('fonts/wysiwyg.woff?2140760') format('woff'), url('fonts/wysiwyg.ttf?2140760') format('truetype'), url('fonts/wysiwyg.svg?2140760#wysiwyg') format('svg');
}
@font-face {
  font-family: 'icomoon';
...
.mce-floatpanel div.mce-stack-layout-item .mce-ico {
  top: 1px;
}
.mce-i-bold:before {
  content: '\e838';
...
.is-focused .mce-edit-area {
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.1), 0 0 5px -1px rgba(0, 128, 191, 0.5);
  -webkit-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.1), 0 0 5px -1px rgba(0, 128, 191, 0.5);
  border-color: #0080bf #0091d9 #0091d9;
